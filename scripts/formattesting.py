...
#fs, audio = wavfile.read('C:/Users/chis/Documents/GitHub/ENSC429_Group3/data/bird_chirp.wav')
audio, fs = librosa.load('../data/Samples/sunflower-street-drumloop.mp3', sr = None)
